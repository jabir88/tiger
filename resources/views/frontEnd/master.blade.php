...
@include('frontEnd.inc.buttontoggle')
	<!-- modals -->
	<!-- log in -->
@include('frontEnd.inc.regmodel')
	<!-- register -->

	<!-- //modal -->
	<!-- //top-header -->
  @include('frontEnd.inc.btmheader')
  @include('frontEnd.inc.signupmodel')
...
@yield('contents')
	...
	@include('frontEnd.inc.copyright')
	<!-- //copyright -->
